...
8я и 9я ячейки могут временно использоваться для всего, но после использования должны очищаться.
...
+[>+
    ...
    Блок 1      Инициализация чисел в 10 и 11 ячейке
    -<[-]+<[-]+>>[<-<->]<[<-]>[->
        >>>>>+++++++>++++<<<<<<
    <]>
    ...
    Блок 3      Добавление B к A
    -<[-]+<[-]+>>[<-<->]<[<-]>[->
        >>[>+>+<<-]>>[<<+>>-]<[<<+>>-]<<<
    <]>

    Блок 4      Перемещение числа из регистра A
    -<[-]+<[-]+>>[<-<->]<[<-]>[->
        >[>>+<<-]<
    <]>
