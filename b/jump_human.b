...
16я ячейка - адрес последней незанятой ячейки в стеке. Если в ней 0 - стек пуст.
17я, 18я и 19я ячейки используются для операций со стеком.
...
+[>
    ...
    >>>>>>>>>>>>>
    [>
        <[>>>+<<<-]>                    Перемещение 15ой ячейки в 18ю
        Перемещение значения из 18ой ячейки в стек:
        >[-]>>[-]<<< [>+>>+<<<-]>>>[<<<+>>>-]<<< [>>[>+<-]<[>+<-]<[>+<-]>>>>[<<<<+>>>>-]<<<-] >[<+>>>+<<-]>>[<<+>>-]<<<
        >>>>[-]<<[>>+<<-]<<             Запись C в стек
        [<[>>>>+<<<<-]>[<+>-]>[<+>-]>[<+>-]<<<-] >[<+>-]<
        +
    ...
    >[-]>[-]<<[>>+<]>[<]>[-<            (if) Выполнять pop только если в стеке есть данные
        -
        >[-]>>[-]<<< [>+>>+<<<-]>>>[<<<+>>>-]<<< [>>[>+<-]<[>+<-]<[>+<-]>>>>[<<<<+>>>>-]<<<-] >[<+>>>+<<-]>>[<<+>>-]<<<
        >>[-]>>[<<+>>-]<<<<             Чтение из стека в C
        [<[>>>>+<<<<-]>[<+>-]>[<+>-]>[<+>-]<<<-] >[<+>-]<
